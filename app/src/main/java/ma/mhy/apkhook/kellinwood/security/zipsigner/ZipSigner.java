...
/**
 * 项目名 apkhook
 * 所在包 ma.mhy.apkhook.ma.mhy.apkhook.kellinwood.security.zipsigner
 * 作者 mahongyin
 * 时间 2019/4/8 11:53
 * 邮箱 mhy.work@qq.com
 * 描述 说明:
...
import ma.mhy.apkhook.kellinwood.zipio.ZioEntry;
import ma.mhy.apkhook.kellinwood.zipio.ZipInput;
            ...
            throws IOException, GeneralSecurityException
    {
        if (keySet.getSigBlockTemplate() != null) {
            ...
            try {
                ...
                Class generatorClass = Class.forName("ma.mhy.apkhook.kellinwood.security.zipsigner.optional.SignatureBlockGenerator");
