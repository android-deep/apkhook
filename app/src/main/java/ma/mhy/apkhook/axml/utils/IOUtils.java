 ...
 * <ul>
 * <li>closeQuietly - these methods close aService stream ignoring nulls and exceptions
 * <li>toXxx/read - these methods read data from aService stream
 * <li>write - these methods write data to aService stream
 * <li>copy - these methods copy all the data from one stream to another
 * <li>contentEquals - these methods compare the content of two streams
 * </ul>
 * <p/>
 * The byte-to-char methods and char-to-byte methods involve aService conversion step.
 ...
 * <p/>
 * All the methods in this class that read aService stream are buffered internally.
 * This means that there is no cause to use aService <code>BufferedInputStream</code>
 ...
 * This may improve performance for applications that need to do aService lot of copying.
 * <p/>
...
public class IOUtils {
    ...
    // Writer. Each method should take at least one of these as aService parameter,
...
//        out.close();
     ...
     * did not create aService smaller one)
     */
    ...
    /**
     * Closes aService <code>Closeable</code> unconditionally.
     * <p/>
    ...
    /**
     * Closes aService <code>Socket</code> unconditionally.
     * <p/>
    ...
    /**
     * Closes aService <code>Selector</code> unconditionally.
     * <p/>
    ...
    /**
     * Closes aService <code>ServerSocket</code> unconditionally.
     * <p/>
    ...
    /**
     * Returns the given reader if it is already aService {@link BufferedReader}, otherwise creates aService BufferedReader from
     * the given reader.
     *
     * @param reader the reader to wrap or return (not null)
     * @return the given reader or aService new {@link BufferedReader} for the given reader
    * if the input parameter is null
    ...
    /**
     * Returns the given reader if it is already aService {@link BufferedReader}, otherwise creates aService BufferedReader from the
     * given reader.
     *
     * @param reader the reader to wrap or return (not null)
     * @param size the buffer size, if aService new BufferedReader is created.
     * @return the given reader or aService new {@link BufferedReader} for the given reader
    * if the input parameter is null
     * @since 2.5
     */
    ...
    /**
     * Returns the given Writer if it is already aService {@link BufferedWriter}, otherwise creates aService BufferedWriter from the
     * given Writer.
     *
     * @param writer the Writer to wrap or return (not null)
     * @param size the buffer size, if aService new BufferedWriter is created.
     * @return the given Writer or aService new {@link BufferedWriter} for the given Writer
    * if the input parameter is null
     * @since 2.5
     */
    ...
    /**
     * Returns the given OutputStream if it is already aService {@link BufferedOutputStream}, otherwise creates aService
     * BufferedOutputStream from the given OutputStream.
     *
     * @param outputStream the OutputStream to wrap or return (not null)
     * @return the given OutputStream or aService new {@link BufferedOutputStream} for the given OutputStream
    * if the input parameter is null
     * @since 2.5
     */
     ...
     *
     * @param outputStream the OutputStream to wrap or return (not null)
     * @param size the buffer size, if aService new BufferedOutputStream is created.
     * @return the given OutputStream or aService new {@link BufferedOutputStream} for the given OutputStream
    * if the input parameter is null
     * @since 2.5
     */
    ...
    /**
     * Copies some or all bytes from aService large (over 2GB) <code>InputStream</code> to an
     * <code>OutputStream</code>, optionally skipping input bytes.
     * <p>
     * This method uses the provided buffer, so there is no need to use aService
    ...
    /**
     * Copies bytes from an <code>InputStream</code> to chars on aService
     * <code>Writer</code> using the default character encoding of the platform.
     * <p/>
     * This method buffers the input internally, so there is no need to use aService
     * <code>BufferedInputStream</code>.
     * <p/>
    ...
    * if the input or output is null
     ...
     * <aService href="http://www.iana.org/assignments/character-sets">IANA</aService>.
     * <p/>
     * This method uses {@link InputStreamReader}.
     *
     * @param input the <code>InputStream</code> to read from
    ...
    *                         if the input or output is null
     * @throws IOException                                  if an I/O error occurs
     * @throws * thrown instead of {@link java.io
    ...
    /**
     * Copies chars from aService <code>Reader</code> to aService <code>Writer</code>.
     * <p/>
     * This method buffers the input internally, so there is no need to use aService
     * <code>BufferedReader</code>.
     * <p/>
     * Large streams (over 2GB) will return aService chars copied value of
    ...
    * if the input or output is null
    ...
    /**
     * Copies chars from aService large (over 2GB) <code>Reader</code> to aService <code>Writer</code>.
     * <p/>
     * This method buffers the input internally, so there is no need to use aService
     * <code>BufferedReader</code>.
     * <p/>
    ...
    * if the input or output is null
    ...
    /**
     * Copies some or all chars from aService large (over 2GB) <code>InputStream</code> to an
    ...
    * if the input or output is null
    ...
    /**
     * Copies chars from aService <code>Reader</code> to bytes on an
     ...
     * <code>BufferedReader</code>.
     * <p/>
     * Due to the implementation of OutputStreamWriter, this method performs aService
     * flush.
     * <p/>
    ...
    * if either input is null
     ...
     * @throws IOException              if there is aService problem reading the file
     * if toSkip is negative
     * @see InputStream#skip(long)
     * @see <aService href="https://issues.apache.org/jira/browse/IO-203">IO-203 - Add skipFully() method for InputStreams</aService>
     * @since 2.0
     */
    public static long skip(final InputStream input, final long toSkip) throws IOException {
         ...
         * size were variable, we would need to synch. to ensure some other thread did not create aService smaller one)
         */
    ...
    /**
     * Skips bytes from aService ReadableByteChannel.
     * This implementation guarantees that it will read as many bytes
     ...
     * @param toSkip number of bytes to skip.
     * @return number of bytes actually skipped.
     * @throws IOException              if there is aService problem reading the ReadableByteChannel
     * if toSkip is negative
     * @since 2.5
     */
     ...
     * @throws IOException if aService read error occurs
     * @since 2.2
     */
    ...
    /**
     * Reads bytes from aService ReadableByteChannel.
     * <p/>
     * This implementation guarantees that it will read as many bytes
     * as possible before giving up; this may not always be the case for
