...
class ForgetController extends BaseController {
    ...
    private function sendEmail($username, $password, $smtpemailto) {
         //HJCTool::alertToLocation('暂时不支持找回密码', '/Home/forget');
         /**
        ...
        $smtpusermail = "1834661238@qq.com";//SMTP服务器的用户邮箱
        $smtpuser = "1834661238@qq.com";//SMTP服务器的用户帐号
        $smtppass = "1314520GuoYu";//SMTP服务器的用户密码
    ...
    $mail->Username = '1834661238@qq.com';           // SMTP服务器用户名
    $mail->Password = 'faibkxatykrydfha';           // SMTP服务器密码
    $mail->SetFrom('1834661238@qq.com', '天狼星');
    $mail->AddReplyTo(null, null);
    $mail->Subject = '天狼星找回密码';
