...
<div class="right-container">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
          <span>欢迎使用缥缈轩网络验证</span>
            <ul class="notice">
                <?php if(is_array($notices)): $i = 0; $__LIST__ = $notices;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    <a href="/Home/notice?nid=<?php echo ($vo["id"]); ?>">[<?php echo ($vo["creat_time"]); ?>] <?php echo ($vo["title"]); ?></a>
