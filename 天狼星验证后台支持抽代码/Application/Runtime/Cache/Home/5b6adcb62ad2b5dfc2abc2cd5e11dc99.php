...
<div class="view">
    <form class="login-form" role="form" id="signupform" name="signupForm" method="post">
        ...
        <div class="form-group">
            <label for="inputPassword" class="control-label">密码 <a href="/Home/forget">忘记密码?</a>
            </label>
        ...
        <div class="form-group">
            <button type="submit" name="login" class="btn btn-primary" tabindex="4">登录</button>
            &nbsp;
            没有账号?&nbsp;<a href="/Home/reg">立即注册</a>
        </div>
    </form>
</div>
</body>
